...
- Android Compose parity: the Kotlin client now shows the same record/summary/settings cards, live activity log, and transcript vault (SRT export) as the Python build, so onboarding demos look identical on both stacks.
