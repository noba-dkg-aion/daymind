...
- **US-13.CI update:** terraform_apply now exports `PYTHONPATH=$(pwd)/../..` before running pytest and the guard test `tests/test_ci_pythonpath_guard.py` ensures the workflow contains the correct export.
